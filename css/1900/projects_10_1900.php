...
.thumb-container-type2 { position:absolute; top:0px; right:0px; text-decoration:none; padding:45px 30px 0 0; }
...
.project-list-item.project .title .title_01 {font-size:20px; font-family: "UniversNextPro-Light";}
.project-list-item.project .title .title_02 {font-size:16px; font-family:'Microsoft JhengHei', 微軟正黑體,sans-serif;}
