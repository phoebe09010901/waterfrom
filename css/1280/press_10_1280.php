...
.thumb-container-type { position:absolute; top:0px; right:0px; text-decoration:none; padding:10px 20px 0 0; }
.thumb-container-type2 { position:absolute; top:0px; right:0px; text-decoration:none; padding:33px 15px 0 0; }
...
.project-list-item.project .title .title_01 {font-size:15px; font-family: "UniversNextPro-Light";}
.project-list-item.project .title .title_02 {font-size:12px; font-family:'Microsoft JhengHei', 微軟正黑體,sans-serif;}
