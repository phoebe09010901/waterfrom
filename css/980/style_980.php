...
.prv_01 {width:25px; height:50px; position:absolute; z-index:6; right:-25px; bottom:117px; opacity:0.3; background:url(images/index_pre_01.png); background-size:25px 50px}
.next_01  {width:25px; height:50px; position:absolute; z-index:6; right:-25px; bottom:68px; opacity:1; background:url(images/index_next_01.png); background-size:25px 50px}
...
.prv_02 {width:25px; height:50px; position:absolute; z-index:5; right:-25px; bottom:117px; opacity:0; background:url(images/index_pre_01.png); background-size:25px 50px}
.next_02  {width:25px; height:50px; position:absolute; z-index:5; right:-25px; bottom:68px; opacity:0; background:url(images/index_next_01.png); background-size:25px 50px}
...
.prv_03 {width:25px; height:50px; position:absolute; z-index:5; right:-25px; bottom:117px; opacity:0; background:url(images/index_pre_01.png); background-size:25px 50px}
.next_03  {width:25px; height:50px; position:absolute; z-index:5; right:-25px; bottom:68px; opacity:0; background:url(images/index_next_01.png); background-size:25px 50px}
...
.prv_04 {width:25px; height:50px; position:absolute; z-index:5; right:-25px; bottom:117px; opacity:0; background:url(images/index_pre_01.png); background-size:25px 50px}
.next_04  {width:25px; height:50px; position:absolute; z-index:5; right:-25px; bottom:68px; opacity:0; background:url(images/index_next_01.png); background-size:25px 50px}


.index_logo { width:57px; height:57px; position:absolute; top:12px; left:18px;}
.index_name { color:#FFF; transform:rotate(-90deg); -webkit-transform:rotate(-90deg); -moz-transform:rotate(-90deg); -ms-transform:rotate(-90deg); letter-spacing:1px; font-family: 'Klill-Light'; font-size:9px; position:absolute; top:105px; left:-20px;}
...
.projects_info {
	...
	.projects_info .info_03 {
		...
		.projects_info .info_03 .teamList { width:470px; display:block;}
		.projects_info .info_03 .teamList .teamList_block {width:235px; height:70px; float:left;}
	...
	.projects_info .info_04 {
		...
		.projects_info .info_04 .font_03 {
			color: #191919; width:40px; font-size:11px; line-height:20px; float:left; height:60px;
		}
		.projects_info .info_04 .font_04 {
			color: #191919; width:100%; font-size:11px; line-height:20px;
		}
	.project_down { width:30px; height:30px; position:absolute; right:-3px; z-index:5;}
...
.news_info {
	...
	.news_info .info_01 .left_info {
		...
		.news_info .info_01 .left_info .font_02 {
			font-size:15px; line-height:24px; font-family: 'MyriadSetPro-Thin'; color:#191919;
		}
		.news_info .info_01 .left_info .font_03 {
			font-size:11px; line-height:18px; color:#3E3A39; width:100%;
		}
		.news_info .info_01 .left_info .more {
			font-size:11px; line-height:18px; color:#656565; font-family: 'Klill-Light'; text-decoration:none;
		}
	...
	.news_info .info_02 .left_info {
		...
		.news_info .info_02 .left_info .font_01 {
			font-size:11px; color:#595757;
		}
		.news_info .info_02 .left_info .font_02 {
			font-size:15px; line-height:24px; font-family: 'MyriadSetPro-Thin'; color:#000;
		}
		.news_info .info_02 .left_info .font_03 {
			font-size:11px; line-height:18px; color:#191919; width:100%;
		}
		.news_info .info_02 .left_info .more {
			font-size:11px; line-height:18px; color:#888; font-family: 'Klill-Light'; text-decoration:none;
		}
...
.news_02_info {
	...
	.news_02_info .left_info {
		...
		.news_02_info .left_info .font_01 {
			font-size:11px; color:#595757; margin-bottom:5px;
		}
		.news_02_info .left_info .font_02 {
			font-size:15px; line-height:24px;font-family: 'MyriadSetPro-Thin'; color:#000; margin-bottom:5px;
		}
		.news_02_info .left_info .font_03 {
			font-size:11px; line-height:18px; color:#191919; width:100%; margin-bottom:10px;
		}
