...
<div>
    ...
    <div class="content3" id="scrollable_div1">
        <script>/*指定右側十格跑到哪格指定位置*/
		$(function(){
			$('.content3').scrollTop(($(window).height()-40)/4*0);
		});
		</script>
		...
		.pic_block.b1:after{ background-color: rgba(72,88,67,.8);}
		@media screen and (min-width: 1900px) {
			.pic_block.b1:after{ padding-top:55px;}
		}
		
		@media screen and (min-width: 1200px) and (max-width: 1900px) {
			.pic_block.b1:after{ padding-top:40px;}   
		}
        ...
        <a href="projects_02.php?category=14&id=28"><div class="pic_block b1" data-eng="Residential1" data-zh="室內設計1"></div></a>
        <style>
