...
$query = "select id, file1, file2, file3, file4, title, url_to, sort, pub, create_time, edit_time from $table_name where lang='".$_SESSION[Login_System_User]['lang']."' and category=$category $where_str order by sort asc";	
