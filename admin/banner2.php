...
?>
	<script>location.replace('banner2_handle.php?id=1');</script>
<?	
	break;
}
...
?>
	<script>location.replace('banner2_handle.php?id=2');</script>
<?	
	break;
}
...
?>
	<script>location.replace('banner2_handle.php?id=3');</script>
<?	
	break;
}
...
?>
	<script>location.replace('banner2_handle.php?id=4');</script>
<?	
	break;
}
