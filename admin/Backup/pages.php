...
$query = "select id, title, sort, pub, create_time, edit_time from $table_name where lang='".$_SESSION[Login_System_User]['lang']."' $where_str order by sort desc";	
$obj_pages->count_page($query, $page_go, $page_num);
$page_all = $obj_pages->page_all;
$obj_all  = $obj_pages->obj_all;
//subtitle
$page_subtitle = '';
if($category!=0) {		
	$tmp_prev = $category;
...
<div class="admin-panel">
  ...
  <div class="main set_page_h page_shadow">
   ...
   <?php $obj_drawtable->drawTable($obj_pages->result_data); ?>
