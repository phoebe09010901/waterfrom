...
?>
	<script>location.replace('contactus_handle.php?id=1');</script>
<?	
	break;
}
...
?>
	<script>location.replace('contactus_handle.php?id=2');</script>
<?	
	break;
}
...
?>
	<script>location.replace('contactus_handle.php?id=3');</script>
<?	
	break;
}
...
?>
	<script>location.replace('contactus_handle.php?id=4');</script>
<?	
	break;
}
