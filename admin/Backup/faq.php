...
$query = "select id, title, hit_counts, pub, sort, create_time, edit_time from $table_name where lang='".$_SESSION[Login_System_User]['lang']."' $where_str order by sort desc, id desc";
...
if($category!=0) {		
	...
	do{
		...
		$page_subtitle = "<a href=".$main_str."_category.php?category=".$pc['id']."><li class='left'>".$pc['content']."</li></a>".$page_subtitle;
		$tmp_prev = $pc['prev'];
	}while($pc['prev']!=0);
}
?><!DOCTYPE HTML>
