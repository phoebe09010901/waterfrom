...
$query = "select id, memberIDkey, title, content, pub, create_time, edit_time from $table_name $where_str order by create_time desc";	
$obj_forum->count_page($query, $page_go, $page_num);
$page_all = $obj_forum->page_all;
$obj_all  = $obj_forum->obj_all;
?><!DOCTYPE HTML>
<html>
<head>
...
<div class="admin-panel">
  ...
  <div class="main set_page_h page_shadow">
   ...
   <?php $obj_drawtable->drawTable($obj_forum->result_data); ?>
