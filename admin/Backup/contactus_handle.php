...
$(document).ready(function () {
	...
	$('#<?=$main_str?>_form').jqxValidator({
		rules: [
		{ input: '#content1', message: '請輸入標題', action: 'keyup, blur', rule: 'required' }, 
		{ input: '#content2', message: '請輸入標題', action: 'keyup, blur', rule: 'required' }], 		
		theme: theme
	});
});
</script>
   	 ...
   	 <div id="data_content">
   		<form method="post" id="<?=$main_str?>_form" action="<?=$_SERVER['PHP_SELF']?>">
            ...
            <table class="<?=$main_str?>-table">
                <tr>
                    <td height="60">Contact Us1：</td>
                    <td><textarea id="content1" name="content1" rows="10"><?=stripslashes($contactus['content1'])?></textarea></td>
                </tr>
                <tr>
                    <td height="60">Contact Us2：</td>
                    <td><textarea id="content2" name="content2" rows="10"><?=stripslashes($contactus['content2'])?></textarea></td>
                </tr>                
                <tr>
