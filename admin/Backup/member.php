...
$query = "select id, account, name, birthday, email, pub_by_admin, login_time, edit_time from $table_name $where_str order by account asc";	
$obj_member->count_page($query, $page_go, $page_num);
$page_all = $obj_member->page_all;
$obj_all  = $obj_member->obj_all;
?><!DOCTYPE HTML>
<html>
<head>
...
<div class="admin-panel">
  <?php include("include_menu.php"); ?><!--slidebar end-->
   ...
   <?php $obj_drawtable->drawTable($obj_member->result_data); ?>
