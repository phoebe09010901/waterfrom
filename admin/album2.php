...
$query = "select id, title, title2, pub, sort, create_time, edit_time from $table_name where lang='".$_SESSION[Login_System_User]['lang']."' and category = '$category' $where_str order by album_date desc";	
