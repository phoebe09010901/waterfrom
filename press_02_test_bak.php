...
<link rel="icon" type="image/png" href="favicon.png" />
    ...
    <script>
	$(function(){
		$('.content3').scrollTop($(window).height()/4*0);
...
<div>
    ...
    <div class="content3" id="scrollable_div1">
		...
		.pic_block.b1:after{ background-color: rgba(167,167,154,.8);}
		@media screen and (min-width: 1900px) {
			.pic_block.b1:after{ width:100%; height:100%; background-color: rgba(167,167,154,.8); padding-top:55px;}
		}
		
		@media screen and (min-width: 1200px) and (max-width: 1900px) {
			.pic_block.b1:after{ width:100%; height:100%; background-color: rgba(167,167,154,.8); padding-top:40px;}   
		}
		
		@media screen and (max-width: 1200px) {
			.pic_block.b1:after{ width:100%; height:100%; background-color: rgba(167,167,154,.8); padding-top:30px;}  
		}
        </style>
