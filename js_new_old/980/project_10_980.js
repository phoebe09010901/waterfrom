...
$(document).ready(function(){
	...
	$(".boxgrid").animate({
		width: (($(window).height()-20)/4) + 'px',
		height: (($(window).height()-20)/4) + 'px'
	});
	$(".boxcaption").animate({
		width: (($(window).height()-20)/4) + 'px',
		height: (($(window).height()-20)/4) + 'px'
	...
	$(".content2").animate({
		width: (($(window).height()-20)/4) + 'px',
		right: (($(window).height()-20)/4+25) + 'px'
	});
	$(".content3").animate({
		width: (($(window).height()-20)/4) + 'px',
		height: (($(window).height()-20)) + 'px'
	...
	$(".projects-grid-pane .projects-list").animate({
		maxWidth: (($(window).height()-20)/4) + 'px'
	});
	$(".projects-grid-pane .projects-list:last-child").animate({
		left: (($(window).height()-20)/4) + 'px'
	});
